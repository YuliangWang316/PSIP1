...
CD8T<-subset(HNSCC,idents = c("5","7"))
...
for (i in 1:26) {
  ...
  assign(paste("CD8T_",i,"_TIL",sep = ""),subset(CD8T,idents = paste("TIL",i,sep = "")))
  assign("d",slot(get(paste("CD8T_",i,"_TIL",sep = "")),"assays"))
  assign("e",as.data.frame(t(as.data.frame(d$RNA@data))))
  ...
  #colnames(e)<-"A"
  assign(paste("scaldata_",i,"_TIL",sep = ""),data.frame(mean(c$PSIP1),mean(f$IFNG)))
...
rm(CD8T_1_TIL,CD8T_10_TIL,CD8T_11_TIL,CD8T_12_TIL,CD8T_13_TIL,CD8T_14_TIL,CD8T_15_TIL,CD8T_16_TIL,CD8T_17_TIL,CD8T_18_TIL,CD8T_19_TIL,
   CD8T_2_TIL,CD8T_20_TIL,CD8T_21_TIL,CD8T_22_TIL,CD8T_23_TIL,CD8T_24_TIL,CD8T_25_TIL,CD8T_26_TIL,CD8T_3_TIL,CD8T_4_TIL,CD8T_5_TIL,CD8T_6_TIL,CD8T_7_TIL,CD8T_8_TIL,CD8T_9_TIL)
rm(f)
colnames(scaldata)<-c("PSIP1","IFNG")
library(ggplot2)
library(ggpubr)
ggplot(data = scaldata,aes(x=PSIP1,y=IFNG)) + geom_point(color="blue",size=3.4) + stat_smooth(method = "lm",se=TRUE,size=1.5,color="red")+stat_cor(data = scaldata,method = "pearson") +  theme_set(theme_bw()) +  theme_set(theme_bw()) 
